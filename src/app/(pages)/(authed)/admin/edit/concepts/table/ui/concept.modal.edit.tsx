...
interface EditConceptModalProps {
    ...
    editStateHelper: ( concepts: ExtendedConcepts[] , toast: string ) => any;
}


export default function EditConceptModal ({ concept, state, modalAction, editStateHelper }: EditConceptModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        try {
            ...
            editStateHelper( challengesUpdated , 'edited concept' );
            modalAction(false);
        } 
        catch (error) {
            console.error(error);
