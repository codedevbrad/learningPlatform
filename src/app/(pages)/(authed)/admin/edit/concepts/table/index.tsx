...
// import useSWR, { mutate } from 'swr';
// import { Table, TableBody, TableCaption, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
// import { action__getConcepts, action_updateTopicStatus, action_updateTopicDetails , action__updateTopicPositions } from "../actions";
// import { ExtendedConcepts } from '@/../prisma/schema.types';
// import AddConceptPopup from './ui/concept.popup.add';
// import ConceptControlDropdown from './ui/concept.popup.control';
// import AddTopicModal from './ui/topic.popup.add';
...
// // Concept Component ...
// const Concept = ({ concept, updateTableFunction, editInputValue, setEditInputValue, setEditingCell, editingCell }) => {
//   const [topics, setTopics] = useState([]);
//   const [isSorted, setIsSorted] = useState(false);
...
//         let topicsUpdated = await action__updateTopicPositions({ 
//           conceptId: concept.id ,
//           topicPositions : topicsSortedMap 
//         });

//         setIsSorted(false); 
//         console.log('updating positions' , topicsUpdated );
//       }
//       catch ( error ) {
//         console.error( error );
//       }
...
//             { isSorted && (
//                 <div className='flex justify-end mb-5'>
//                     <Button onClick={handleUpdateSorted} className="btn">
//                       Update Table
//                     </Button>
//                 </div>
//             )}
...
//       <DndContext sensors={useSensors(useSensor(PointerSensor, { activationConstraint: { distance: 10 } }))} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
//         <SortableContext items={topics.map(topic => topic.id)} strategy={verticalListSortingStrategy}>
//           <Table>
//             <TableCaption>Topics for {concept.title}</TableCaption>
//             <TableHeader className="bg-gray-100">
