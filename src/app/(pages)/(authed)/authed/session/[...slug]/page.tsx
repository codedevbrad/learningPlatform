...
const SessionInProgress = ({ session }) => {
    ...
    return (
      <Card className="w-5/6 p-7 space-y-5">
            <div className="flex justify-center">
                <Title title={`${session.title} is in progress!`} variant="Heading" noMargin={false} />
            ...
            <Card className="flex flex-row px-5">
                ...
                <div className="flex flex-row space-x-5 items-center">
                    <h3 className="font-bold"> 
                        Zoom Link 
                    </h3> : <span className="font-bold text-sm p-1 px-4 rounded-lg bg-blue-100 text-blue-800"> ab4skskxs_ajsnsns </span> 
                </div>            
