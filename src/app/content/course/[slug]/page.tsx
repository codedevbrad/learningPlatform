...
import CourseSidebarComponent from "./panel.sidebar"
const reactQuizData = {
    type: 'quiz',
    title: 'React.js Quiz',
    quizData: [
...
export default function Page({ params }: { params: { slug: string } }) {
    ...
    return (
      <div className="h-full flex flex-row">
        <CourseMainComponent courseInfo={ course.info } data={ course.data } />
        <CourseSidebarComponent references={ course.references } />
      </div>
    )
}